            ...
            <div className="bg-white text-[#333333] flex flex-col relative">
                <div className="mx-auto text-center mt-14 mb-20 sm:mb-24">
                    <div className="h-[60px] w-[60px] mx-auto">
                        <Image src={zoom} alt="zoom" height={10000} width={10000} />
                    </div>
                    <h1 className="text-[35px] sm:text-[52px] font-[700] mt-0">Durekt for Zoom</h1>
                    <p className="text-[15px] sm:text-[18px] text-[#5B5B5B] font-[500]">Integrate Durekt to Zoom to boost sales performance..</p>
                    <div className="w-[130px] mx-auto mt-6">
                        <Button className="rounded-md" >Get Started</Button>
                    </div>
                </div>

                <div className="bg-[#2A74F7] min-h-[17em] sm:min-h-[21.5em] p-3 relative">
                    <Image src={"/images/laptop-zoom.png"} height={500} width={500} className="mx-auto relative z-[2]" alt="alt-text" />
                ...
                <div className="w-[90%] md:w-[40em] mx-auto text-center mt-[50px] sm:mt-[100px] mb-[50px]">
                    <h1 className="font-[700] text-[28px] sm:text-[30px] leading-[35px] mb-8 sm:mb-12 ">Improve sales experience via Zoom call with Durekt</h1>
