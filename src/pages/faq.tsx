            ...
            <div className="bg-white px-[1em] sm:px-[3.5em] mdx5:px-[5em] pb-[3em] pt-[4em] mdx3:py-[5em] text-center">
                ...
                <div className="flex w-[95%] sm:w-[35em] mx-auto mt-[4em] mb-[5em] ">
                    <div className="flex-[2]">
                        <Search containerClassName="rounded-none rounded-tl-[7px] rounded-bl-[7px] overflow-hidden border-[#D4D4D4]" className=" w-full h-[2.3em] text-black rounded-tl-[7px] rounded-bl-[7px] bg-[#F4F1F1]" value="" onChange={() => {}} />
                    </div>
                ...
                <div className="grid sm:grid-cols-2 mdx4:grid-cols-3 gap-x-12 gap-y-8 sm:gap-y-10">
                    {[0,2,3,4,5,6,5,2,1].map(item => (
                        <div className=" text-left">
                            <h2 className="text-[#333333] font-[700] text-[20px] sm:text-[24px] mb-3 sm:mb-5">Lorem Ipsum Title</h2>
                            <p className="text-[#5B5B5B] font-[500] text-[15px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
