    ...
    return (
        <>
            ...
            <div className="flex gap-10 mt-7">
                <div className="border text-[0.9em] text-[#333333] rounded-md font-normal border-[#D4D4D4] flex-1 text-center py-1 flex justify-center items-center gap-2">
                    <Google />
                    <p>Google</p>
                </div>
                <div className="border text-[0.9em] text-[#333333] rounded-md font-normal border-[#D4D4D4] flex-1 text-center py-1 flex justify-center items-center gap-2">
            ...
            <div className="mb-6">
                <div className="flex flex-col items-start mb-4">
                    <label className="text-[#333333] font-medium text-[0.9em]">Email</label>
                    <input className="w-full mt-2 p-2 border border-[#D0D5DD] rounded-md" type="email" placeholder="Enter Your Email" name="Email" />
                </div>
                <div className="flex flex-col items-start mb-4">
